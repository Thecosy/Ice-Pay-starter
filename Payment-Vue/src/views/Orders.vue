    ...
    <section id="index" class="container">
      ...
      <el-table :data="list" border style="width: 100%">
        ...
        <el-table-column label="操作" width="100" align="center">
          <template slot-scope="scope">
            <el-button v-if="scope.row.orderStatus === '未支付'" type="text" @click="cancel(scope.row.orderNo,scope.row.payMent)">取消</el-button>
            <el-button v-if="scope.row.orderStatus === '支付成功'" type="text" @click="refund(scope.row.orderNo,scope.row.payMent)">退款</el-button>
          </template>
        </el-table-column>
      </el-table>
    </section>
